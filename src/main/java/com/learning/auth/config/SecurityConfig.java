...
import com.learning.auth.filter.BasicAuthFilter;
import com.learning.auth.filter.JwtAuthFilter;
import com.learning.auth.filter.RoleAccessFilter;
import com.learning.auth.filter.RoleAuthFilter;
...
public class SecurityConfig {
    ...
    @Autowired
    private RoleAccessFilter roleAccessFilter;
    @Bean
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(roleAccessFilter, RoleAuthFilter.class);
